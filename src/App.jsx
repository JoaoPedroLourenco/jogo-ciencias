...
// const palavrasFaltando = ["transcrição", "polimerase", "ribossomos"]
...
function App() {
  ...
  // const [palavraInserida, setPalavraInserida] = useState([])

  const handleSubmit = (e) => {
    
      setPalavra(e.target.value)
      // setPalavraInserida([...palavraInserida, palavra])
      // setPalavra("")
  }
